...
<div class='hero'>
  ...
  <h1 class="header-title">Trattamenti Corpo e viso</h1>
</div>

<section class="dark">
	<div class="container py-4">
		<h1 class="h1 text-center" id="pageHeaderTitle">TRATTAMENTI VISO</h1>
...
<section class="light">
	<div class="container py-2">
		<div class="h1 text-center text-dark" id="pageHeaderTitle">TRATTAMENTI CORPO</div>
