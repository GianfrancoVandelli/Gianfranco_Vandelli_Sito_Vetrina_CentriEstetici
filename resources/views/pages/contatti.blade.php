...
<section class="me">
    ...
    <div class="card-header">
        <div class="card-cover" style="background-color:#f9d8b3"></div>
        ...
        <h1 class="card-fullname">Sarah De Ceglia</h1>
        <h2 class="card-jobtitle">Estetista</h2>
    </div>
    <div class="card-main">
...
<section id="dove-siamo" class="where-section container" aria-label="Dove siamo">
  <div class="where-grid">
    <div class="where-map" aria-hidden="false">
      <!-- Sostituisci l'URL nell'attributo src con il tuo embed Google Maps o OpenStreetMap -->
      <iframe
        title="Mappa: posizione del centro estetico"
        src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d24018.686126265402!2d16.614699599999994!3d41.1926528!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sit!2sit!4v1772562405096!5m2!1sit!2sit" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
        loading="lazy"
        referrerpolicy="no-referrer-when-downgrade"
        allowfullscreen
        aria-label="Mappa interattiva con la posizione del centro estetico"></iframe>
    </div>

    <aside class="where-info" aria-labelledby="where-title">
      <h2 id="where-title">Dove siamo</h2>
      <p class="address">Via Esempio 12, 70056 Molfetta (BA)</p>
      <p class="muted">Parcheggio disponibile; ingresso su strada principale</p>

      <ul class="where-list">
        <li><strong>Telefono</strong>: <a href="tel:+390801234567">+39 080 123 4567</a></li>
        <li><strong>Email</strong>: <a href="mailto:info@tuocentro.it">info@tuocentro.it</a></li>
        <li><strong>Orari</strong>: Lun–Ven 09:00–18:00; Sab 09:00–14:00</li>
      </ul>

      <p class="actions">
        <a id="directions-link" class="btn-doveSiamo" href="https://www.google.com/maps/dir/?api=1&destination=Via+Esempio+12+Molfetta" target="_blank" rel="noopener">Indicazioni stradali</a>
        <a class="btn-doveSiamo ghost" href="tel:+390801234567">Chiama</a>
      </p>

      <p class="map-fallback-note">Se la mappa non si carica, <a class="contact-link" href="https://www.google.com/maps/dir/?api=1&destination=Via+Esempio+12+Molfetta" target="_blank" rel="noopener">apri Google Maps</a>.</p>
    </aside>
  </div>
</section>
